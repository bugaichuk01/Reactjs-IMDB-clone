...
import styles from './UIFlag.module.scss';
...
export const UIFlag = () => {
    return (
        <div className={styles.flag}>
            ...
            {/*
            <svg className={styles.ribbon_shadow} >
                <polygon className={styles.polygon_shadow} points="24 0 0 0 0 32 12.2436611 26.2926049 24 31.7728343" />
            </svg>*/}
